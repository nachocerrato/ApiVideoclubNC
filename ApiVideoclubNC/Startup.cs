...
namespace ApiVideoclubNC
{
    public class Startup
    {
        ...
        {
            string cadena = this.Configuration.GetConnectionString("cadenapeliculas");
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ApiVideoclubNC", Version = "v1" });
            });
        }
